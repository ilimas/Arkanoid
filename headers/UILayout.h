...
// resolution presets).
constexpr Rect MenuPanel{768, 224, 608, 652};
...
constexpr Rect MenuButtonRect(int index)
{
    return Rect{MenuButtonX, MenuButtonStartY + index * (MenuButtonH + MenuButtonSpacing), MenuButtonW, MenuButtonH};
}

constexpr bool PointInRect(int px, int py, const Rect &r)
{
